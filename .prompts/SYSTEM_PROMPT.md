...
```json
{
  ...
  "domain": "string (one of 14 approved domains: GenerativeAI, DevOps, Cloud, MLOps, RAG, Embeddings, Chunking, VectorDatabases, AICloudArchitecture, CostOptimization, PerformanceOptimization, Microservices, SoftwareEngineeringBestPractices, AIApplicationDevelopment)",
